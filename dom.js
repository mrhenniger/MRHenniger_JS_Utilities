...
class Dom {
    ...
    constructor(ref = null) {
        this.className = "Dom";
        this.__core = null;
        ref = (ref === null || ref === void 0 ? void 0 : ref.name) === "Strings" ? ref.str() : ref;
        this.__svgCache = {};
        ...
        else if ((ref === null || ref === void 0 ? void 0 : ref.className) === 'Dom') {
    ...
    __getMultiples(eleID) {
        ...
        let redux = this.find(eleStrs[0]).getCore(); // We specify any and not Dom[] since we may mark some of them as disqualified/null
     ...
     * @return  null|HTMLElement[]  A null for an error, otherwise and array of HTMLElements are returned.
     */
    __getElementsByClassName(eleID) {
        eleID = typeof eleID === 'string' ? new Strings(eleID) : eleID; // Ensure eleID is a Strings
        eleID = eleID.trim().whitespaceCondense();
        eleID = eleID.trim();
        if (!eleID.starts('.')) {
     ...
     */
    static create(eleTag, attributes = {}) {
    ...
    addClass(refClass) {
        ...
        if (typeof ((_b = (_a = this.__core) === null || _a === void 0 ? void 0 : _a.classList) === null || _b === void 0 ? void 0 : _b.add) === 'undefined') {
    ...
    removeClass(targetClass) {
        ...
        if (typeof ((_b = (_a = this.__core) === null || _a === void 0 ? void 0 : _a.classList) === null || _b === void 0 ? void 0 : _b.remove) === 'undefined') {
    ...
    hasClass(refClass) {
        ...
        if (typeof ((_b = (_a = this.__core) === null || _a === void 0 ? void 0 : _a.classList) === null || _b === void 0 ? void 0 : _b.contains) === 'undefined') {
    ...
    getClassList() {
        var _a;
        if (typeof ((_a = this.__core) === null || _a === void 0 ? void 0 : _a.classList) === 'undefined') {
