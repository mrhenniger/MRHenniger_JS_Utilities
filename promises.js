...
class Promises {
     ...
     */
    constructor(param = null, options = {}) {
        var _a;
        ...
        let theTimeout = typeof (param === null || param === void 0 ? void 0 : param.timeout) !== 'undefined' ? Number(param === null || param === void 0 ? void 0 : param.timeout) : // TODO: Revisit this, do we need to check param for a timeout value?
        ...
        if (param !== null && typeof param === 'object' && ((_a = param === null || param === void 0 ? void 0 : param.constructor) === null || _a === void 0 ? void 0 : _a.name) === 'Promise') {
            this.__core = param;
        ...
        else if (typeof param === 'object' && (param === null || param === void 0 ? void 0 : param.className) === 'Promises') {
        ...
        else if (typeof param === 'object' && (param === null || param === void 0 ? void 0 : param.length)) {
     ...
     * @return  Promises  Returns self to allow for chaining of commands.
     */
    setTimeout(timeLimitMilliSeconds) {
